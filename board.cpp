...
Board::Board()
{
    ...
    m_whiteKing = qSharedPointerCast<King>((m_figures.count() > 20 ? m_figures.at(20) : nullptr));
    m_blackKing = qSharedPointerCast<King>((m_figures.count() > 20 ? m_figures.at(4) : nullptr));
    newGame(_gameType);
}
...
Board::operator = ( const Board & other )
{
    ...
    {
        m_figures = std::move( initFigures() );
        m_whiteKing = qSharedPointerCast<King>(m_figures.at( 20 ));
        m_blackKing = qSharedPointerCast<King>(m_figures.at( 4 ));
...
Board::initFigures() const
{
    ...
    {
        return  QList<QSharedPointer<Figure>>();
    }
}
